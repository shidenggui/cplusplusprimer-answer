...
/*    elimDups(words);*/
    ...
    //auto find_start = partition(words.begin(), words.end(), [sz](const string &s){return (s.size() < sz) ? true : false;});
    auto find_start = partition(words.begin(), words.end(), bind(check_size, _1, sz));
